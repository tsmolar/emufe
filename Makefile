...
VERSION = 3.1.4
_libcurl_config = 
abs_builddir = /local/src/x86_64/emufe-3.1.4
abs_srcdir = /local/src/x86_64/emufe-3.1.4
abs_top_builddir = /local/src/x86_64/emufe-3.1.4
abs_top_srcdir = /local/src/x86_64/emufe-3.1.4
ac_ct_CC = gcc
allegro_CFLAGS = 
allegro_LIBS = 
am__include = include
...
install_sh = ${SHELL} /local/src/x86_64/emufe-3.1.4/install-sh
